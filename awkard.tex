...
\\
For all $i, j$ such that $i > j \geq 0$, $C_i$ will have the property that $|C_i|$ $mod$ $|C_j| \geq 1$. Not only that, $|C_i|$ is also the smallest such integer with the property of not being divisible by the previous cycle lengths.\\
\\
